...
def get_cached_llama(
    ...
    try:
        ...
        raise RuntimeError(
            "llama-cpp-python is required for AI inference. "
...
def generate(
    ...
    """Generate raw text completion from the local LLM."""
...
def ask(
    ...
    """Query the local model and return rich Markdown display for Jupyter Notebooks."""
    text = generate(
        prompt=prompt,
